...
def plot_decision_boundary(model, X, y):
    ...
    plt.title('Neural Network Decision Boundary - Gaussian Quantiles')
...
if __name__ == "__main__":
    # Generate dataset - nested Gaussian shells
    ...
    # Create model - similar to circles (needs curved boundary)
    random.seed(17)
    model = MLP(2, [16, 16, 1])
